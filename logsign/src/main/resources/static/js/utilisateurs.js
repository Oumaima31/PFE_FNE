...
const sampleUsersData = [
    ...
    },
    {
        ...
        nom: "Martin",
        prenom: "Marie",
        email: "marie.martin@aviation.fr",
        matricule: "EMP002",
        aeroport: "LFPO",
        motDePasse: "********",
        role: "Validateur"
    },
    {
        ...
        nom: "Dubois",
        prenom: "Pierre",
        email: "pierre.dubois@aviation.fr",
        matricule: "EMP003",
        aeroport: "LFBO",
        motDePasse: "********",
        role: "Utilisateur"
    },
    {
        ...
        nom: "Leroy",
        prenom: "Sophie",
        email: "sophie.leroy@aviation.fr",
        matricule: "EMP004",
        aeroport: "LFML",
        motDePasse: "********",
        role: "Utilisateur"
    },
    {
        ...
        nom: "Bernard",
        prenom: "Thomas",
        email: "thomas.bernard@aviation.fr",
        matricule: "EMP005",
        aeroport: "LFLL",
        motDePasse: "********",
        role: "Validateur"
    ...
    },
    {
        ...
        nom: "Robert",
        prenom: "Michel",
        email: "michel.robert@aviation.fr",
        matricule: "EMP007",
        aeroport: "LFPO",
        motDePasse: "********",
        role: "Admin"
    },
    {
        ...
        nom: "Richard",
        prenom: "Isabelle",
        email: "isabelle.richard@aviation.fr",
        matricule: "EMP008",
        aeroport: "LFBO",
        motDePasse: "********",
        role: "Utilisateur"
    },
    {
        ...
        nom: "Moreau",
        prenom: "Philippe",
        email: "philippe.moreau@aviation.fr",
        matricule: "EMP009",
        aeroport: "LFML",
        motDePasse: "********",
        role: "Utilisateur"
    },
    {
        ...
        nom: "Simon",
        prenom: "Nathalie",
        email: "nathalie.simon@aviation.fr",
        matricule: "EMP010",
        aeroport: "LFLL",
        motDePasse: "********",
        role: "Validateur"
    },
    {
        ...
        nom: "Laurent",
        prenom: "David",
        email: "david.laurent@aviation.fr",
        matricule: "EMP011",
        aeroport: "LFPG",
        motDePasse: "********",
        role: "Utilisateur"
    },
    {
        ...
        nom: "Lefebvre",
        prenom: "Christine",
        email: "christine.lefebvre@aviation.fr",
        matricule: "EMP012",
        aeroport: "LFPO",
        motDePasse: "********",
        role: "Utilisateur"
...
function renderTable() {
    ...
    for (let i = startIndex; i < endIndex; i++) {
        ...
        row.innerHTML = `
            ...
            <td>${formatAeroport(user.aeroport)}</td>
...
// Fonction pour formater le code OACI de l'aéroport
function formatAeroport(code) {
    const aeroportMap = {
        'LFPG': 'Paris-CDG (LFPG)',
        'LFPO': 'Paris-Orly (LFPO)',
        'LFBO': 'Toulouse (LFBO)',
        'LFML': 'Marseille (LFML)',
        'LFLL': 'Lyon (LFLL)'
    };
    
    return aeroportMap[code] || code;
}
...
function openAddUserModal() {
    ...
    document.getElementById('confirmPasswordLabel').innerHTML = 'Confirmer le mot de passe <span class="required">*</span>';
...
function editUser(userId) {
    ...
    document.getElementById('passwordLabel').innerHTML = 'Mot de passe <small>(laisser vide pour ne pas modifier)</small>';
...
function saveUser() {
    ...
    if (isEditMode) {
        ...
        if (userIndex !== -1) {
            ...
            if (motDePasse) {
                usersData[userIndex].motDePasse = "********"; // Dans une vraie application, vous hasheriez le mot de passe
            }
            
            alert(`L'utilisateur ${prenom} ${nom} a été mis à jour avec succès.`);
        }
    } else {
        // Mode ajout
        ...
        const newUser = {
            ...
            matricule,
            aeroport,
            motDePasse: "********", // Dans une vraie application, vous hasheriez le mot de passe
            role
        };
        ...
        alert(`L'utilisateur ${prenom} ${nom} a été ajouté avec succès.`);
    }
